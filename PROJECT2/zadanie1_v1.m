...
[yLP,fLP]=lowPassFilter_v1(sig(:,1),fc_LP, BW);
[yHP,fHP]=highPassFilter_v1(sig(:,1),fc_HP, BW);

[yBP1,fBP1]=bandPassFilter_v1(sig(:,1),fc_LP,fc_BP1, BW);
[yBP2,fBP2]=bandPassFilter_v1(sig(:,1),fc_BP1,fc_BP2, BW);
[yBP3,fBP3]=bandPassFilter_v1(sig(:,1),fc_BP2,fc_HP, BW);
